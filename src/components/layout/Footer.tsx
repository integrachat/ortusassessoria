        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              {config?.logo_url ? (
                <img src={config.logo_url} alt="Logo" className="h-10 brightness-200" />
              ) : (
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-accent rounded-lg flex items-center justify-center">
                    <span className="text-accent-foreground font-bold text-sm">O</span>
                  </div>
                  <span className="font-bold text-lg font-heading">ORTUS</span>
                </div>
              )}
            </div>
            <p className="text-background/60 text-sm leading-relaxed mb-6">
              Contabilidade digital completa para o seu negócio crescer com segurança.
            </p>
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 bg-background/10 rounded-lg flex items-center justify-center hover:bg-accent transition-colors"
              >
                <Facebook size={16} />
              </a>
              <a
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-base mb-5 font-heading">Links Rápidos</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="font-bold text-base mb-5 font-heading">Serviços</h4>
            <ul className="space-y-3">
          ...
          {servicesColumn2.length > 0 && (
            <div>
              <h4 className="font-bold text-base mb-5 font-heading invisible">Mais</h4>
              <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold text-base mb-5 font-heading">Contato</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Phone size={16} className="text-accent mt-0.5 flex-shrink-0" />
                <span className="text-background/60 text-sm">{config?.phone || "(00) 0000-0000"}</span>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={16} className="text-accent mt-0.5 flex-shrink-0" />
                <span className="text-background/60 text-sm">{config?.email || "contato@empresa.com"}</span>
              </li>
              <li className="flex items-start gap-3">
                <MapPin size={16} className="text-accent mt-0.5 flex-shrink-0" />
                <span className="text-background/60 text-sm">{config?.address || "Seu endereço aqui"}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-background/40">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/termos-uso" className="hover:text-background transition-colors">
                Termos de Uso
              </Link>
            </div>
          </div>
